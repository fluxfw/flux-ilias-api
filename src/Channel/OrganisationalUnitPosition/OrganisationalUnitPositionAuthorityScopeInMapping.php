...
namespace FluxIliasApi\Channel\OrganisationalUnitPosition;

use FluxIliasApi\Adapter\OrganisationalUnitPosition\LegacyOrganisationalUnitPositionAuthorityScopeIn;
