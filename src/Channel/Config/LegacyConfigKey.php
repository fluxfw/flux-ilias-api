 ...
 * @method static static ENABLE_FLUX_ILIAS_REST_OBJECT_API_PROXY() enable_flux_ilias_rest_object_api_proxy
 * @method static static ENABLE_FLUX_ILIAS_REST_OBJECT_WEB_PROXY() enable_flux_ilias_rest_object_web_proxy
