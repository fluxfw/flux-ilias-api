 ...
 * @method static static FLUX_ILIAS_REST_OBJECT_API_PROXY_MAPS() flux_ilias_rest_object_api_proxy_maps
 * @method static static FLUX_ILIAS_REST_OBJECT_DEFAULT_ICON_URL() flux_ilias_rest_object_default_icon_url
 * @method static static FLUX_ILIAS_REST_OBJECT_MULTIPLE_TYPE_TITLE() flux_ilias_rest_object_multiple_type_title
 * @method static static FLUX_ILIAS_REST_OBJECT_TYPE_TITLE() flux_ilias_rest_object_type_title
 * @method static static FLUX_ILIAS_REST_OBJECT_WEB_PROXY_MAPS() flux_ilias_rest_object_web_proxy_maps
