...
namespace FluxIliasApi\Channel\CourseMember;
...
use FluxIliasApi\Channel\ObjectLearningProgress\LegacyInternalObjectLearningProgress;
use FluxIliasApi\Channel\ObjectLearningProgress\ObjectLearningProgressMapping;
use ilDBConstants;
use ilLPStatus;
use ilObjCourse;
use LogicException;
