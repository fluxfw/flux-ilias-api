...
export async function storeForm(form_el) {
    ...
    const values = {
        ...
        enable_object_api_proxy: form_el.elements.enable_object_api_proxy.checked,
        enable_object_web_proxy: form_el.elements.enable_object_web_proxy.checked,
        ...
        object_api_proxy_map: getEntriesFormValue("object_api_proxy_map", ["key", "url"], form_el),
        object_web_proxy_map: getEntriesFormValue("object_web_proxy_map", ["iframe_url", "key", "page_title", "rewrite_url", "short_title", "view_title"], form_el),
        ...
        web_proxy_map: getEntriesFormValue("web_proxy_map", ["iframe_url", "menu_item", "menu_title", "page_title", "rewrite_url", "short_title", "target_key", "view_title", "visible_public_menu_item"], form_el)
    };
