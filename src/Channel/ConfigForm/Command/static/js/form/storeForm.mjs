...
export async function storeForm(form_el) {
    ...
    const values = {
        ...
        enable_flux_ilias_rest_object_api_proxy: form_el.elements.enable_flux_ilias_rest_object_api_proxy.checked,
        enable_flux_ilias_rest_object_web_proxy: form_el.elements.enable_flux_ilias_rest_object_web_proxy.checked,
        ...
        flux_ilias_rest_object_api_proxy_map: getEntriesFormValue("flux_ilias_rest_object_api_proxy_maps", ["key", "url"], form_el),
