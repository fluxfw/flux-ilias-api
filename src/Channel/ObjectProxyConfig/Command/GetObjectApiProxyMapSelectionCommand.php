...
class GetObjectApiProxyMapSelectionCommand
{
    ...
    {
        return (object) [
            "value"  => $this->object_proxy_config_service->getObjectApiProxyMapKey(
                $id
            ),
            "values" => array_map(fn(ObjectApiProxyMapDto $object_api_proxy_map) : string => $object_api_proxy_map->key, $this->proxy_config_service->getObjectApiProxyMap())
        ];
    }
}
